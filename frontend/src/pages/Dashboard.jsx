...
const Dashboard = ({ role }) => {
  ...
  const citizenCards = [
    ...
    { title: 'My Complaints',       description: 'View history of all your submitted complaints',link: '/my-complaints',       accentColor: { bg: 'rgba(66,153,225,0.10)', text: '#4299E1' }, icon: <FileText  className="w-5 h-5" style={{ color: '#4299E1' }} /> },
